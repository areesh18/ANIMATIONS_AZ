...
initializeScene(createTextTexture("AREESH", "Impact", null, "#ffffff", "100"));
...
function animateScene() {
  ...
  // Send current and previous positions to shader
...
function handleMouseMove(event) {
  ...
  // Store the previous target position BEFORE updating
